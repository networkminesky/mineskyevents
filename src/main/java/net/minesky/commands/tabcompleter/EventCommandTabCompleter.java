...
public class EventCommandTabCompleter implements TabCompleter {
    private final List<String> id = Arrays.asList("anunciar", "blacklist", "entrar", "kick", "set", "start", "finalizar", "force");
    ...
    public List<String> onTabComplete(CommandSender s, Command cmd, String lbl, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (args[0].isEmpty()) {
                ...
                addIfPermitted(s, completions, "mineskyevents.command.event.force", "force");
            }
            ...
            if (args[0].equalsIgnoreCase("blacklist")) {
                ...
                completions = getMatches(args[1], Utils.getPlayersInEvent(), s, "mineskyevents.command.event.kick");
            } else if (args[0].equalsIgnoreCase("force")) {
                completions = getMatches(args[1], Arrays.asList("start", "skip"), s, "mineskyevents.command.event.force");
            }
