...
public class TNTTagEvent {
                        ...
                        for (Player player : Bukkit.getOnlinePlayers()) {
                            if (Util.PDVE(player)) {
                                ...
                                if (tempoRestante == 120) {
                                    player.sendTitle("§8[§cTNT-TAG§8]", "§7INICIANDO EM§8: §c2m", 10, 70, 20);
                                    player.playSound(player, Sound.BLOCK_NOTE_BLOCK_BANJO, 1.0f , 1.0f);
                                }
                            }
                        }
    ...
    public static void finalizar() {
        ...
        int premio1 = random.nextInt(Config.TNTTAG_MAX_1 - Config.TNTTAG_MIN_1 + 1) + Config.TNTTAG_MIN_1;
        int premio2 = random.nextInt(Config.TNTTAG_MAX_2 - Config.TNTTAG_MIN_2 + 1) + Config.TNTTAG_MIN_2;
        int premio3 = random.nextInt(Config.TNTTAG_MAX_3 - Config.TNTTAG_MIN_3 + 1) + Config.TNTTAG_MIN_3;
