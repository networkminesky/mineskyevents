                        ...
                        for (Player player : Bukkit.getOnlinePlayers()) {
                            if (Util.PDVE(player)) {
                                ...
                                if (tempoRestante == 120) {
                                    player.sendTitle("§8[§9Corrida de Barco§8]", "§7INICIANDO EM§8: §92m", 10, 70, 20);
                                    player.playSound(player, Sound.BLOCK_NOTE_BLOCK_BANJO, 1.0f , 1.0f);
                                }
                            }
                        }
        ...
        if (lapCount + 1 == 3) {
            ...
            if (EventCorridasPlayerManager.getPlayerCount() >= 3) {
                ...
                for (int i = 0; i < 3; i++) {
                    ...
                    if (i == 0) {
                        premio = random.nextInt(Config.CORRIDABOAT_MAX_1 - Config.CORRIDABOAT_MIN_1 + 1) + Config.CORRIDABOAT_MIN_1;
                        premio1 = premio;
                    }
                    if (i == 1) {
                        premio = random.nextInt(Config.CORRIDABOAT_MAX_2 - Config.CORRIDABOAT_MIN_2 + 1) + Config.CORRIDABOAT_MIN_2;
                        premio2 = premio;
                    }
                    if (i == 2) {
                        premio = random.nextInt(Config.CORRIDABOAT_MAX_3 - Config.CORRIDABOAT_MIN_3 + 1) + Config.CORRIDABOAT_MIN_3;
                        premio3 = premio;
                    }
